...
2. [Inflação do vocabulário](https://jakobnielsenphd.substack.com/p/ux-vocabulary-inflation) é um desabafo barra crítica do Jakob Nielsen, o “pai” do termo UX (*User Experience*). Ele argumenta que a disciplina sofre constantes reinvenções da terminologia e isso leva a confusão, desinformação e retrabalho.
...
4. [Como predizer](https://productdesign.substack.com/p/how-to-predict-if-a-user-will-use) que um usuário vai usar seu produto antes mesmo de lançá-lo. *Spoiler*: pensar no processo de tomada de decisão e suas implicações.
5. Já ouviu falar da [Pirâmide da Comunicação](https://productmindset.substack.com/p/2836-mckinseys-pyramid-framework)? É um *framework* para estruturar grande pedaços de informação para contar histórias sem omitir detalhes importantes. Vai mudar sua maneira de apresentar suas ideias!
