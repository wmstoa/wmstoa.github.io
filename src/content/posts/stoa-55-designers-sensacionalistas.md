---
title: Designers Sensacionalistas
pubDate: '2025-04-28'
---
...
- Aulas novas sobre: **[Paginação](https://componentes.design/aulas/paginacao)**, **[Tabs](https://componentes.design/aulas/tabs)**, **[Grids & Layouts](https://componentes.design/aulas/grid-layout)**.
- Você pode agendar **[mentorias comigo aqui](https://componentes.design/mentorias/willianmatiola)**.
- E com outros mentores **[aqui](https://componentes.design/mentorias)**.
- Tenho feito muitas **[lives no YouTube](https://www.youtube.com/@willianmatiola)**.

![Foto que tirei no Pexels Meetup Düsseldorf. Modelo: Nathalia](./_assets/stoa-55-designers-sensacionalistas-1.jpg)
...
Em um país em que mais de 26% da população sofre de transtorno de ansiedade, não me parece uma prática muito saudável[1](#footnote-1).

![](./_assets/stoa-55-designers-sensacionalistas-2.png)
...
![](./_assets/stoa-55-designers-sensacionalistas-3.png)
...
![](./_assets/stoa-55-designers-sensacionalistas-4.png)

![Meu livro sobre Tipografia](./_assets/stoa-55-designers-sensacionalistas-5.jpg)

[Saiba mais →](https://www.editorabrauer.com.br/livros-de-design/tipografia-e-interface)

![](./_assets/stoa-55-designers-sensacionalistas-6.png)
...
Recentemente, li um artigo chamado “**[Design Isn’t Dead. You Sound Dumb](https://medium.com/design-bootcamp/design-isnt-dead-you-sound-dumb-4253e50940e7)**” (O design não morreu. Você parece idiota), em que o autor expõe com precisão que esse tipo de pessoa na verdade nunca entendeu o que é Design:

> “Você achava que design era decoração. Uma demão de tinta. Um layout no Figma. Você presumia que, uma vez que estivesse bom, o trabalho estaria feito. Então, agora que a IA consegue gerar uma landing page, você acha que designers estão obsoletos?”.[2](#footnote-2)
...
![](./_assets/stoa-55-designers-sensacionalistas-7.png)
...
![](./_assets/stoa-55-designers-sensacionalistas-8.png)
...
![](./_assets/stoa-55-designers-sensacionalistas-9.png)

## O que achei por aqui

1. **[NotebookLM](https://notebooklm.google.com/) **- Uma IA do Google ótima para extrair conteúdos de vídeos e artigos.
2. **[FloraAI](https://www.florafauna.ai/)** - designers estão usando essa IA generativa para branding e outras áreas.
3. **[Modify](https://modyfi.io/)** - App adquiro pelo Figma para criação de motion design.
4. **[Lovable](https://lovable.dev/?via=willian)** - IA para desenvolvimento de apps via prompt (link de afiliado).
5. **[People's Graphic Design Archive](https://peoplesgdarchive.org/) **- o nome já diz tudo.
6. **[ASCII Tool](https://mitos.shared.oxide.computer/)** - transforme imagens em ASCII
