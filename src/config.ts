...
export const themeConfig: ThemeConfig = {
  ...
  site: {
    ...
    description:
      'A Stoa é um blog escrito por Willian Matiola, um designer, escritor e fotógrafo que escreve sobre design, vida, sociedade, filosofia e outras coisas interessantes.', // Site description
